...
Проверка на существоение свойства в объекте происхоидит путем его сравнивания с undefined: obj.name === undefined. Так же существует специальный оператор для проверки это 'in': console.log('age' in obj) // true
--------
